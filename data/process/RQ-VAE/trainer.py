...
class Trainer(object):
    ...
    def constrained_km(self, data, n_clusters=10):
        # Since diversity loss is disabled (beta=0 and code commented out),
        # return dummy labels to save computation time
        dummy_labels = [i % n_clusters for i in range(len(data))]
        return None, dummy_labels
